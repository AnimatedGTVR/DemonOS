...
/**
 * Keep in sync with Border in pekwm_types.hh
 */
enum CursorType {
	CURSOR_0 = 0,
	CURSOR_TOP_LEFT = 0,
...
public:
	...
	static long queryTime(bool select_input);
	...
	static bool grabKeyboard(Window win, bool owner_events = false);
	...
	static bool setCardinal(Window win, AtomName aname, Cardinal value,
				long format=XA_CARDINAL);
	...
	static void drawRectangle(Drawable d, GC gc, const Geometry &gm);
...
private:
	...
	static bool _has_extension_xscrnsaver;
