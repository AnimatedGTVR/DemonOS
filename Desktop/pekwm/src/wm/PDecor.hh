...
public:
	...
	void setEdgeFilled(Edge edge)
	{
		_fill_state = (edge != EDGE_NO ? FILL_STATE_EDGE : 0);
		_edge_filled = edge;
	}
	...
	Border getBorderPosition(Window win) const {
...
private:
	...
	void getBorderSize(Border pos, uint &width, uint &height);
...
protected:
	...
	MouseActionList _decor_cfg_bpr_al_child;
	/** What list to search for title actions. */
	MouseActionList _decor_cfg_bpr_al_title;
	...
	Window _border_win[BORDER_NO]; /** Array of border windows. */
