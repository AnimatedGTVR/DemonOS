...
enum WinLayouterType { // Map
	WIN_LAYOUTER_TYPE_SMART = (1 << 0),
	WIN_LAYOUTER_TYPE_CENTERED = (1 << 1),
	WIN_LAYOUTER_TYPE_CENTEREDONPARENT = (1 << 2),
	WIN_LAYOUTER_TYPE_MOUSENOTUNDER = (1 << 3),
	WIN_LAYOUTER_TYPE_MOUSECENTERED = (1 << 4),
	WIN_LAYOUTER_TYPE_MOUSETOPLEFT = (1 << 5),
	WIN_LAYOUTER_TYPE_NO = (1 << 6)
};
