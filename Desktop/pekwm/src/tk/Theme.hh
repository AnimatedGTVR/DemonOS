...
public:
	...
	private:
		...
		PTexture *_texture_border
			[FOCUSED_STATE_FOCUSED_SELECTED][BORDER_NO];
	...
	public:
		...
		//! @brief Returns text pad in Pad dir.
		int getPad(Pad dir) const {
	...
	public:
		...
		//! @brief Returns text pad in Pad dir.
		inline int getPad(Pad dir) const {
			return _pad[(dir != PAD_NO) ? dir : 0];
		}
