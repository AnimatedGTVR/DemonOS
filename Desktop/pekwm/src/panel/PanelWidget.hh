...
public:
	...
	bool isRequiredSize() const {
		return _size_req.getUnit() == WIDGET_UNIT_REQUIRED
			|| _size_req.getUnit() == WIDGET_UNIT_REQUIRED_MAX;
	}
	virtual void scaleChanged() { };
	std::string getIf() { return _if_tfo.format(); }
	virtual uint getRequiredSize(uint max = 0) { return 0; }
