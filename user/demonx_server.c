...
#define incoming (*(struct demonx_transport *)(uintptr_t)0x324000u)
#define outgoing (*(struct demonx_transport *)(uintptr_t)0x324040u)
#define windows ((struct demonx_window *)(uintptr_t)0x324080u)
