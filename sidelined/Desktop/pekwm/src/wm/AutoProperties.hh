 ...
 */
enum PropertyType { // Map
	PROPERTY_TYPE_STICKY = (1L << 1),
	PROPERTY_TYPE_SHADED = (1L << 2),
	PROPERTY_TYPE_MAXIMIZED_VERTICAL = (1L << 3),
	PROPERTY_TYPE_MAXIMIZED_HORIZONTAL = (1L << 4),
	PROPERTY_TYPE_ICONIFIED = (1L << 5),
	PROPERTY_TYPE_BORDER = (1L << 6),
	PROPERTY_TYPE_TITLEBAR = (1L << 7),
	PROPERTY_TYPE_FRAME_GEOMETRY = (1L << 8),
	PROPERTY_TYPE_CLIENT_GEOMETRY = (1L << 9),
	PROPERTY_TYPE_LAYER = (1L << 10),
	PROPERTY_TYPE_WORKSPACE = (1L << 11),
	PROPERTY_TYPE_SKIP = (1L << 12),
	PROPERTY_TYPE_FULLSCREEN = (1L << 13),
	PROPERTY_TYPE_PLACE_NEW = (1L << 14),
	PROPERTY_TYPE_FOCUS_NEW = (1L << 15),
	PROPERTY_TYPE_FOCUSABLE = (1L << 16),
	PROPERTY_TYPE_CFG_DENY = (1L << 17),
	PROPERTY_TYPE_ALLOWED_ACTIONS = (1L << 18),
	PROPERTY_TYPE_DISALLOWED_ACTIONS = (1L << 19),
	PROPERTY_TYPE_OPACITY = (1L << 20),
	PROPERTY_TYPE_DECOR = (1L << 21),
	PROPERTY_TYPE_ICON = (1L << 22),
	PROPERTY_TYPE_PLACEMENT = (1L << 23),
	PROPERTY_TYPE_NO
};

enum PropertyGroup { // Map
	PROPERTY_GROUP_SIZE,
	PROPERTY_GROUP_BEHIND,
	PROPERTY_GROUP_FOCUSED_FIRST,
	PROPERTY_GROUP_GLOBAL,
	PROPERTY_GROUP_RAISE,
	PROPERTY_GROUP_NO
};
