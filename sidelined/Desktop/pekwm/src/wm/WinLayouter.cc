...
public:
	LayouterSmart() : WinLayouter(WIN_LAYOUTER_TYPE_SMART) {}
...
public:
	LayouterCentered(void) : WinLayouter(WIN_LAYOUTER_TYPE_CENTERED) {}
...
public:
	LayouterCenteredOnParent(void)
		: WinLayouter(WIN_LAYOUTER_TYPE_CENTEREDONPARENT)
	{
	}
...
public:
	LayouterMouseNotUnder() : WinLayouter(WIN_LAYOUTER_TYPE_MOUSENOTUNDER)
	{
	}
...
public:
	LayouterMouseCentred() : WinLayouter(WIN_LAYOUTER_TYPE_MOUSECENTERED)
	{
	}
...
public:
	LayouterMouseTopLeft() : WinLayouter(WIN_LAYOUTER_TYPE_MOUSETOPLEFT)
	{
	}
...
{
	enum WinLayouterType type = pekwm::str_to_win_layouter_type(name);
...
{
	switch (type) {
	case WIN_LAYOUTER_TYPE_SMART:
		return new LayouterSmart();
	case WIN_LAYOUTER_TYPE_CENTERED:
		return new LayouterCentered();
	case WIN_LAYOUTER_TYPE_CENTEREDONPARENT:
		return new LayouterCenteredOnParent();
	case WIN_LAYOUTER_TYPE_MOUSENOTUNDER:
		return new LayouterMouseNotUnder();
	case WIN_LAYOUTER_TYPE_MOUSECENTERED:
		return new LayouterMouseCentred();
	case WIN_LAYOUTER_TYPE_MOUSETOPLEFT:
