...
public:
	...
	static bool fillEdgeGeometry(const Geometry &head, Edge edge,
	...
	static void actionDetachClientSplitVert(PWinObj *oldf, PWinObj *newf,
						float new_aspect);
	static bool actionMoveToEdge(PWinObj *wo, Edge edge);
...
private:
	...
	bool actionFillEdge(Frame *frame, Edge edge, int percent);
	bool isEdgeOpposites(Edge lhs, Edge rhs);
	...
	void actionFocusDirectional(PWinObj *wo, Direction dir, bool raise);
