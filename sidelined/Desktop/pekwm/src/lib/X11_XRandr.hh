...
public:
	...
	virtual bool canUseCrtc(RRCrtc crtc) const = 0;
	virtual bool supportsMode(RRMode mode) const = 0;
};
...
public:
	...
	virtual bool disableOutput(X11_XRandr_OutputInfo *oi) = 0;
	virtual bool disableOutput(RRCrtc crtc) = 0;
