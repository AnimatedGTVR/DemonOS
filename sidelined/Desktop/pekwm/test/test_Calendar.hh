...
TestCalendar::run_test(TestSpec spec, bool status)
{
	...
	TEST_FN(spec, "curDay", testCurDay());
...
void
TestCalendar::testCurDay()
{
	Calendar c1(1737011287);
	ASSERT_EQUAL("curDay", 16, c1.getMDay());
	ASSERT_EQUAL("curDay", 7, c1.getHour());
	Calendar c2 = c1.curDay();
	ASSERT_EQUAL("curDay", "2025-01-16T00:00:00Z", c2.toString());
	ASSERT_EQUAL("curDay", 16, c2.getMDay());
	ASSERT_EQUAL("curDay", 0, c2.getHour());
}
